...
export default async function PeptidePage({
  ...
  // Built from Zod-validated peptide data; no user input. Inlined into
  // the SSG HTML so search engines see it without executing JS.
  const jsonLd = {
    ...
    <article>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 py-12 lg:py-16">
          ...
          <div className="flex flex-wrap items-center gap-2 mb-6">
            ...
            <CitationDensityBadge
              cited={stats.cited_claims}
              total={stats.total_claims}
              density={stats.citation_density}
            />
      ...
      <SectionFilterProvider available={available}>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 py-10 space-y-16">
          ...
          <FilteredSection category="side-effects" id="side-effects" className="scroll-mt-32">
          ...
          <FilteredSection category="administration" id="administration" className="scroll-mt-32">
          ...
          {p.synergy && p.synergy.stacks.length > 0 && (
            <FilteredSection category="synergy" id="synergy" className="scroll-mt-32">
          ...
          <section className="border-t border-[var(--color-border)] pt-8 text-[12px] text-[var(--color-text-muted)] flex flex-wrap items-center gap-3">
            ...
            {stats.uncited_claims > 0 && (
              <span className="text-[var(--color-badge-yellow)]">
                {stats.uncited_claims} field
                {stats.uncited_claims === 1 ? "" : "s"} uncited — open contributions
              </span>
            )}
            <a
